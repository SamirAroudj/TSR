 ...
 */
#ifndef _SURFACE_RECONSTRUCTION_APP_MAGIC_CONSTANTS_H_
#define _SURFACE_RECONSTRUCTION_APP_MAGIC_CONSTANTS_H_
...
#endif // _SURFACE_RECONSTRUCTION_APP_MAGIC_CONSTANTS_H_
